...
const menuItems = [
    ...
    },
    {
      ...
      icon: <IoCalculator size={40}/>,
      title: 'Pokemons',
      subTitle: 'Description for pokemons'
  },
...
export const Sidebar = () => {
  return (
    <>
    <div id="menu" style={{width: '400px'}} className="bg-gray-900 min-h-screen z-10 text-slate-300 w-64 fixed left-0 h-screen overflow-y-scroll">
